...
/**
 * @file
 * Hooks provided by the Deploy Extra Formats module.
 */
 ...
 */
function hook_deploy_extra_formats_methods() {
  $methods = array(
    'form' => array(
 ...
 */
function hook_deploy_extra_formats_methods_alter(&$methods) {
 ...
 */
function hook_deploy_extra_formats_export_formats() {
  // Set the path where are formats plugins.
  $path = drupal_get_path('module', 'deploy_extra_formats') . '/plugins/export_formats';
  return array(
    'OwnPluginName' => array(
